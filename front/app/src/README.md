# 단위 테스트 & CI 자동화 (12주차 과제)

## 링크

| 항목 | 링크 |
|------|------|
| 테스트 코드 | [front/app/src/config/__tests__/](https://github.com/nadasoom2/yhs_AIOSS/tree/main/front/app/src/config/__tests__) |
| 테스트 코드 | [front/app/src/utils/__tests__/](https://github.com/nadasoom2/yhs_AIOSS/tree/main/front/app/src/utils/__tests__) |

| CI 워크플로우 | [frontend-test.yml](https://github.com/nadasoom2/yhs_AIOSS/blob/main/.github/workflows/frontend-test.yml) |
