...
한국에 처음 온 유학생은 해결해야 할 행정 문제가 많습니다.

- 외국인등록증은 언제 어디서 만드는지
- D-4 비자로 아르바이트를 할 수 있는지
- 건강보험료를 미납했을 때 어떻게 해야 하는지

이런 정보들은 학교 홈페이지 곳곳에 흩어져 있고, 대부분 한국어로만 제공됩니다. 유학생 담당 부서에 직접 찾아가거나, 선배에게 물어보거나, 번역기를 돌려가며 직접 찾아야 하는 상황입니다.
...
"Can I work part-time with D-4 visa?"
    ↓
"D-4 비자의 경우 입국 후 6개월이 경과한 후 시간제취업이 가능합니다.
 학기 중에는 주 20시간 이내로 제한되며, TOPIK 2급 이상이 필요합니다."
```
...
환경 변수 및 Neo4j 초기 데이터 세팅 방법은 [docs/setup.md](docs/setup.md)를 참고하십시오.
